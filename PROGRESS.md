...
| **In progress** | **Nothing in progress.** WI-548 (Sweep: every taxonomy type has a full guide) shipped 2026-09-23 and is CLOSED — do not reopen it. Next item is **WI-549 (T8 Neurological and thinking/memory testing)**, not yet started. |
