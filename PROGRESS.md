...
| **In progress** | **Nothing mid-flight.** WI-534 (`/treatments/shunts`) is LIVE — PR #133/#134, deployed and smoke-checked 2026-09-15. **Before WI-535, weigh WI-439** (the Kestrel test-host flake): it fired THREE times on 2026-09-15 (WI-533's lone main run, WI-534's paired release runs), and on `main` it silently skips the deploy. The historical WI-534 pickup notes follow. | 
