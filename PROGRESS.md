...
| **In progress** | **WI-549 (T8 Neurological and thinking/memory testing) — CODE COMPLETE, awaiting commit approval (Gate 2), 2026-09-23.** Everything below is done and green; nothing is committed yet. Branch is still `develop` with the work in the tree. |
